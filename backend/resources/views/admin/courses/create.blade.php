        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            ...
            <form action="{{ route('admin.courses.store') }}" method="POST" class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="duration_hours" class="block text-sm font-medium text-gray-700 mb-2">Duration (Hours)
                            *</label>
                ...
                <div>
                    <label for="max_participants" class="block text-sm font-medium text-gray-700 mb-2">Maximum Participants
                        *</label>
